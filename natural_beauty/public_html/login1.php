...
$status=1;
$log=mysqli_query($con,"insert into userlog(userEmail,userip,status) values('".$_SESSION['user_email']."','$uip','$status')");
...
<html lang="en">
	<head>
	    ...
	    <title>AYA Natural Beauty| Sign-in | Signup Users</title>
...
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availability_user.php",
