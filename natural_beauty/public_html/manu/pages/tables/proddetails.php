                        ...
                        <tbody>
                          ...
                          <tr>
                             ...
                             <td>
                              ...
                              <span class="pl-2"><?php echo $row['product_name']; ?></span>
                            </td>
                            ...
                            <td>
                              <a href="update_product.php?id=<?php echo $row['id']; ?>"><div class="badge badge-outline-success">Update</div></a>
                            </td>
                            <td>
                              <a href="delete_product.php?id=<?php echo $row['id']; ?>"><div class="badge badge-outline-success">Delete</div></a>
                            </td>
                          </tr>
						  ...
						  <td>
                              ...
                              <span class="pl-2">Accessories</span>
                            </td>
                          ...
                          <tr>
                            <td>
                              ...
                              <span class="pl-2">Household</span>
                            </td>
                            <td>
