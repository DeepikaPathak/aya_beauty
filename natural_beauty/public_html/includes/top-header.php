...
<?php if(strlen($_SESSION['user_email']))
    {   ?>
				...
				<?php } ?>
					...
					<?php if(strlen($_SESSION['user_email'])==0)
    {   ?>
...
<?php }
				...
				<?php } ?>	
<li><a href="loginvendor.php"><i class="icon fa fa-sign-in"></i>Vendor</a></li>

<li><a href="loginadmin.php"><i class="icon fa fa-sign-in"></i>Admin</a></li>
				</ul>
			</div><!-- /.cnt-account -->
