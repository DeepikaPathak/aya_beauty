 <!--partial:partials/_sidebar.html -->
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav" style="margin-top:3rem;">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/subadmin.php">
              <span class="menu-icon">
		  ...
		  <li class="nav-item menu-items">
            <a class="nav-link" href="pages/charts/manulist.php">
              <span class="menu-icon">
		   ...
		   <li class="nav-item menu-items">
            <a class="nav-link" href="pages/charts/manuprod.php">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/charts/orderstatus.php">
              <span class="menu-icon">
              ...
              <span class="menu-title">Order Status</span>
                 ...
                 <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/payout.php">
              <span class="menu-icon">
                <i class="mdi mdi-chart-bar"></i>
              </span>
              <span class="menu-title">Manufacturer Payout</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/charts/maintainance.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/charts/renting.php">
              <span class="menu-icon">
                <i class="mdi mdi-screwdriver"></i>
              </span>
              <span class="menu-title">Renting Service</span>
            </a>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/client.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/finance.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/team.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
