        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <?php 
                ...
                $i=0;
                $pname=array();
                $q = "select * from finance where date >=$sdate AND date <= $edate ";
                $result = mysqli_query($con, $q);
                $num = mysqli_num_rows($result);
                if ($num == 0) {
                    echo "No Financd Details for this slot";
            ...
            <div class="row ">
                <div class="col-12 grid-margin">
                    ...
                    for($x = 0; $x < $l; $x++) {
                        ...
                        $q1 = "select SUM(expenses) as value_sum from finance where project='$pname[$x]'";
                        $result1 = mysqli_query($con, $q1);
                        $rowstart1 = mysqli_fetch_assoc($result1);
                        $exp= $rowstart1['value_sum'];
                        $q2 = "select SUM(revenue) as value_sum from finance where project='$pname[$x]'";
                        $result2 = mysqli_query($con, $q2);
                        $rowstart2 = mysqli_fetch_assoc($result2);
                        $rev= $rowstart2['value_sum'];
                        $pro=$rev-$exp;   
                ?>
                                <tbody>
                                <tr>
                                    <td>
                                    <span class="pl-2"><?php echo $pname[$x] ?></span>
                                    </td>
                                    <td><?php echo $rev ?></td>
                                    <td><?php echo $exp ?></td>
                                    <td><?php echo $pro ?></td>
