        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add a Sub Admin </h3>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Fill out the details </p>
                    <form class="forms-sample" action="subadminscript.php" target="_self" method ="post">
					<div class="row">
                        <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="cpassword" id="exampleInputConfirmPassword1" placeholder="Password">
                      </div>
