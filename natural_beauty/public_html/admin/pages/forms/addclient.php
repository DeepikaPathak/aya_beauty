              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Fill out the details of Client </p>
                    <form class="forms-sample" action="addclientscript.php" target="_self" method ="post">
					  <div class="row">
                        <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="project" class="form-control" id="exampleInputProject" placeholder="Project Name">
                      </div>
                      <div class="row">                      
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Est. Cost</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Est. Duration</label>
                                <div class="col-sm-9">
                      ...
                      <div class="form-group">
                        <label for="exampleInputDes">Project Description</label>
                        <input type="text" name="description" class="form-control" id="exampleInputDes" placeholder="Project Description">
                      </div>
                      <button type="submit" class="btn btn-primary mr-2">Create Profile</button>
