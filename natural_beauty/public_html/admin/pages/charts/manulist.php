        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> List of Active Manufactures</h3>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                              ...
                              <?php 
							  $sql = "SELECT * FROM manufacts where status=1";
						...
						if($num == 0)  {
                            ...
                            <td> <?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM `manu_products` where manu_id=".$row['id']))?> </td>
                            <td><?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM `purchased` where paymentstatusno='1' and manuid=".$row['id']))?> </td>
                            <td>
                              <a href="delmanu.php?un=0&id=<?php echo $row['id'];?>" class="badge badge-outline-danger">Block</a>
                            </td>
                          </tr>
						<?php } ?>     
                        </tbody>
                      ...
                      <br>
                      <br>
                      <h4 class="card-title">Blocked Account</h4>
                      <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                              ...
                              <?php 
							  $sql = "SELECT * FROM manufacts where status=0";
						$result = mysqli_query($con, $sql);
						$num = mysqli_num_rows($result);
						...
						if($num == 0)  {
                            ...
                            <td><?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM `purchased` where paymentstatusno='1' and manuid=".$row['id']))?> </td>
                            <td>
                              <a href="delmanu.php?un=1&id=<?php echo $row['id'];?>" class="badge badge-outline-success">Unblock</a>
                            </td>
                          </tr>
						<?php } ?>     
                        </tbody>
