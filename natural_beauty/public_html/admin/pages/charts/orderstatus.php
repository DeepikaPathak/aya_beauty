        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Orders placed by Clients</h3>
                      ...
                      <table class="table">
						...
						if($num == 0)  {
                          ...
                          <tr>
                            ...
                            <td><?php echo mysqli_fetch_array(mysqli_query($con, "SELECT product_name FROM `manu_products` where id='".$row['pid']."'"))[0] ?></td>
                            <td><?php echo $row['time']; ?> </td>
                            <?php if($row['paymentstatusno']=='1') { ?>
                            <td>
                              <div class="badge badge-outline-success"><?php echo $row['paymentstatus']; ?></div>
                            </td>
                            <?php } else { ?>
                            <td>
                              <div class="badge badge-outline-danger"><?php echo $row['paymentstatus']; ?></div>
                            </td>
