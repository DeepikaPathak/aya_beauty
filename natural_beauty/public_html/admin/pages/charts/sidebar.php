<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav" style="margin-top:3rem;">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/subadmin.php">
              <span class="menu-icon">
		  ...
		  <li class="nav-item menu-items">
            <a class="nav-link" href="manulist.php">
              <span class="menu-icon">
		   ...
		   <li class="nav-item menu-items">
            <a class="nav-link" href="manuprod.php">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="orderstatus.php">
              ...
              <span class="menu-title">Order Status</span>
               ...
               <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/payout.php">
              <span class="menu-icon">
                <i class="mdi mdi-chart-bar"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="renting.php">
              <span class="menu-icon">
                <i class="mdi mdi-screwdriver"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/client.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/finance.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/team.php">
              <span class="menu-icon">
                <i class="mdi mdi-message-reply"></i>
              </span>
