        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Maintainance Charges</h3>
           ...
           <div class="row">
              ...
              <?php 
                $sql = "SELECT * FROM maintain WHERE id = 1";
                $res = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($res);
              ?>     
                ...
                <button class=" btn btn-success create-new-button" type="submit">Update Price</button> 
           ...
           <form method="post" action="m1.php"> 
            <?php 
                $sql = "SELECT * FROM maintain WHERE id = 2";
                $res = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($res);
              ?>        
					<div class="form-group"style="margin-top:2rem;">
